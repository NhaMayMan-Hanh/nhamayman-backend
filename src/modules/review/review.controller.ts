...
class ReviewController {
   ...
   async getAllReviewAdmin(req: Request, res: Response) {
      try {
         const reviews = await reviewService.getAllReviewAdmin(req.query);
         ...
         console.log("Error getAllReviewAdmin:", error);
         return res.status(500).json({
            success: false,
